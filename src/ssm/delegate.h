...
// This source code is stolen from http://codereview.stackexchange.com/questions/14730/impossibly-fast-delegate-in-c11
...
namespace std
{
  ...
  struct hash<::SimpleStateMachine::delegate<R (A...)> >
  {
    size_t operator()(::SimpleStateMachine::delegate<R (A...)> const& d) const noexcept
    {
      auto const seed(hash<void*>()(d.object_ptr_));

      return hash<typename ::SimpleStateMachine::delegate<R (A...)>::stub_ptr_type>()(
